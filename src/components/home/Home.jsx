    ...
    <section className="py-20 bg-gradient-to-b from-white to-brand-50/50">
      ...
      >
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-['Inter-Bold'] text-slate-900 mb-4">
          ...
          {features.map((feature, index) => (
            <div key={index} className="relative group">
              ...
              <div className="bg-slate-900 rounded-3xl p-8 pr-12 pb-10 relative overflow-hidden transition-all duration-500 hover:-translate-y-3">
                ...
                <div className="pt-8">
                  <h3 className="text-2xl font-['Inter-Bold'] text-white mb-4">
                    {feature.title}
                  </h3>
                  <p className="text-slate-300 font-['Inter-Regular'] leading-relaxed mb-8">
                    {feature.description}
                  </p>
                  <button className="inline-flex items-center gap-2 bg-brand-600 hover:bg-brand-700 text-white font-['Inter-Bold'] px-6 py-3 rounded-xl transition-all duration-300">
                    Book Now
      ...
      >
        ...
        >
          <div className="flex flex-col gap-4 sm:gap-5">
            ...
            <h1
              className={`text-white font-['Inter-Bold'] leading-[1.1] tracking-tight m-0 text-[clamp(2.25rem,6vw,3.75rem)] sm:text-[clamp(2.5rem,5vw,4rem)] ${mounted ? "animate-fade-in-down" : "opacity-0"}`}
              style={{ animationDelay: "200ms" }}
            >
              Experience seamless rides with{" "}
              <span className="!text-brand-300">reliable</span> and affordable
              travel
            </h1>

            <p
              className={`text-white/80 leading-relaxed m-0 max-w-[540px] text-[clamp(1rem,1.3vw,1.15rem)] sm:text-[clamp(1rem,1.3vw,1.15rem)] font-['Inter-Regular'] ${mounted ? "animate-fade-in-down" : "opacity-0"}`}
              style={{ animationDelay: "300ms" }}
            >
              Discover a smarter way to travel with our premium ride services.
              Book effortlessly, track your rides in real-time, and enjoy a
              hassle-free journey across Saint Kitts and Nevis. Your comfort,
              safety, and convenience are our top priorities.
            </p>

            <div
              className={`flex flex-wrap gap-4 mt-3 ${mounted ? "animate-fade-in-down" : "opacity-0"}`}
          ...
          <div
            className={`relative flex items-center justify-center ${mounted ? "animate-slide-from-right" : "opacity-0 translate-x-16"}`}
            style={{ animationDelay: "200ms" }}
          >
            <div className="relative w-full max-w-[620px]">
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse at center, rgba(0,74,112,0.18) 0%, transparent 70%)",
                }}
              />
            </div>
          </div>
