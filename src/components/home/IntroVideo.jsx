    ...
    <section className="py-20 bg-white">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8" style={{ maxWidth: 1200 }}>
        <div className="text-center mb-12">
          <span className="inline-block px-4 py-1.5 bg-brand-100 text-brand-700 rounded-full text-sm font-family-semibold mb-4">
            Watch Our Story
          </span>
          <h2 className="text-3xl md:text-4xl font-family-bold text-slate-900 mb-4">
            See How We're Transforming Travel
          </h2>
          <p className="text-slate-600 text-lg max-w-2xl mx-auto font-family-regular">
        ...
        >
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center h-96 bg-slate-50 text-center">
              <p className="text-slate-600 font-family-regular">Unable to load video</p>
            </div>
          ) : (
            FooterData?.videourl && (
              <video 
