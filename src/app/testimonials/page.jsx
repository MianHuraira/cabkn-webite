...
import { mainBanner, jad } from "@/components/assets/Images";
    ...
    <div className={mounted ? "animate-fade-in" : "opacity-0"} style={{ minHeight: "100vh", background: "#f8fafc" }}>
      ...
      >
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", textAlign: "center", position: "relative", zIndex: 1 }}>
          <span style={{ color: "rgba(255,255,255,0.6)", fontSize: 14, fontWeight: 600, letterSpacing: 3, textTransform: "uppercase" }}>Rider Testimonials</span>
      ...
      <section style={{ marginTop: -40, position: "relative", zIndex: 2, padding: "0 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ background: "#fff", borderRadius: 20, padding: "32px 40px", boxShadow: "0 8px 30px rgba(0,0,0,0.06)", border: "1px solid rgba(0,0,0,0.04)", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: 20 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
              <div style={{ textAlign: "center" }}>
                <div style={{ fontSize: 48, fontWeight: 700, color: "#1a1a2e", lineHeight: 1 }}>4.9</div>
                <div style={{ display: "flex", gap: 2, marginTop: 4, justifyContent: "center" }}>{renderStars(4.9)}</div>
                <div style={{ fontSize: 13, color: "#6b7280", marginTop: 4 }}>Average Rating</div>
              </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: 20 }}>
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <p style={{ fontSize: 14, color: "#6b7280", lineHeight: 1.8, margin: "0 0 16px", fontStyle: "italic" }}>&ldquo;{t.text}&rdquo;</p>
                <div style={{ display: "flex", alignItems: "center", gap: 12, borderTop: "1px solid #f3f4f6", paddingTop: 16 }}>
                  <div style={{ width: 40, height: 40, borderRadius: "50%", background: "linear-gradient(135deg, #004a70, #60a5fa)", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: 16, fontWeight: 600, flexShrink: 0 }}>
                    {t.name.charAt(0)}
                  </div>
                  <div>
      ...
      {/* CTA */}
      <SectionReveal>
        <div style={{ background: "linear-gradient(135deg, #004a70 0%, #002d47 100%)", padding: "60px 24px", textAlign: "center" }}>
          <div style={{ maxWidth: 600, margin: "0 auto" }}>
            <h2 style={{ color: "#fff", fontSize: "clamp(1.3rem, 2.5vw, 1.8rem)", fontWeight: 700, margin: "0 0 12px" }}>Ready to Become Our Next Happy Rider?</h2>
            <p style={{ color: "rgba(255,255,255,0.7)", fontSize: 15, margin: "0 auto 24px", lineHeight: 1.7 }}>Sign up today and experience the Cabkn difference for yourself.</p>
            <a href="/auth/stepOne" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "14px 32px", borderRadius: 9999, background: "#fff", color: "#004a70", fontSize: 15, fontWeight: 600, textDecoration: "none", cursor: "pointer", transition: "all 0.2s" }}
